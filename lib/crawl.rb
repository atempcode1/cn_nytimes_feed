...
class Crawl
  ...
  class << self
    def run
      Anemone.crawl("http://cn.nytimes.com/", :threads => 1, :delay => 3, :user_agent => 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.57 Safari/537.1') do |anemone| #单线程,每采集一页面休息3秒
